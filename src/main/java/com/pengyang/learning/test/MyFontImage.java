package com.pengyang.learning.test;
...
public class MyFontImage {
    public static void createFongImg(String path){
        ...
        try{
            ...
            ImageIO.write(newImage, "JPG", new FileOutputStream("C:\\Users\\pengyang10\\Desktop\\duoduonew.jpg"));
        }catch (Exception e){
            e.printStackTrace();
        }
    };
    ...
    public static void main(String args[]){
        MyFontImage.createFongImg("C:\\Users\\pengyang10\\Desktop\\duoduo.jpg");
